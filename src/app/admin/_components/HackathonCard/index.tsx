		...
		<Card>
			<div className="mb-4">
				<div className="flex justify-between items-center mb-2">
					<h3 className="text-xl font-bold text-[var(--black-primary)]">{hackathon.name}</h3>
				...
				<div className="flex flex-col gap-3 p-4 bg-[#f5f5f5] rounded-lg mt-3">
					<div className="flex flex-col gap-2">
						<div className="text-xs font-semibold text-[var(--black-lighten1)] uppercase tracking-wide">採点URL:</div>
						<div className="flex items-center gap-2 flex-wrap">
							<code className="font-['Monaco','Courier_New',monospace] text-[13px] px-3 py-1.5 bg-white border border-[#ddd] rounded text-[var(--black-primary)] break-all flex-1 min-w-0">{scoringUrl}</code>
							<CopyButton text={scoringUrl} />
						</div>
					</div>
					<div className="flex flex-col gap-2">
						<div className="text-xs font-semibold text-[var(--black-lighten1)] uppercase tracking-wide">アクセスパスワード:</div>
						<div className="flex items-center gap-2 flex-wrap">
							<code className="font-['Monaco','Courier_New',monospace] text-[13px] px-3 py-1.5 bg-white border border-[#ddd] rounded text-[var(--black-primary)] break-all flex-1 min-w-0">{hackathon.access_password}</code>
