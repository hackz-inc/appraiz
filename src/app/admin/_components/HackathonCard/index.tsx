		...
		<Card>
			<div className="mb-4">
				<div className="flex justify-between items-center mb-2">
					<h3 className="text-xl font-bold text-black">{hackathon.name}</h3>
				...
				<div className="flex flex-col gap-3 p-4 bg-[#f5f5f5] rounded-lg mt-3">
					<div className="flex flex-col gap-2">
						...
						<div className="flex items-center gap-2 flex-wrap">
							<code className="font-['Monaco','Courier_New',monospace] text-[13px] px-3 py-1.5 bg-white border border-[#ddd] rounded text-black break-all flex-1 min-w-0">
								{`http://localhost:3000/scoring/${hackathon.id}`}
							</code>
							<CopyButton
								text={`http://localhost:3000/scoring/${hackathon.id}`}
							/>
						</div>
					</div>
					<div className="flex flex-col gap-2">
