...
export function AccessPasswordGuard({
	...
	if (isVerified === null) {
		return (
			<div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue to-yellow-lighten1">
				<div className="inline-block animate-spin h-12 w-12 border-4 border-white border-t-transparent rounded-full" />
			</div>
		);
	}
				...
				<Container maxWidth="sm">
					<Card className="w-full">
						<div className="text-center mb-8">
							<div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-yellow-primary mb-4">
